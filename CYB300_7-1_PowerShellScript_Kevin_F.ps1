...
New-Localuser -Name “FKevin” -Password $Password -FullName "Kevin F” -PaswordNeverExpires
Get-Service w* | Out-File c:\W_Services.txt
Get-History | Out-File c:\CYB_300_History_Kevin_F.txt

Rename-Computer -NewName "Kevin_F"
...
Get-History | Out-File c:\SecurityLog_Kevin.txt
